/**
 * PWM regulated Blink app for Silabs Wireless Gecko platforms.
 *
 ...
 * transitions from ON to OFF (or visa versa). Duty cycle change lasts 500ms, 
 * creating the effect that the LED fades to OFF or gradually brightens to ON.
 * 
 * Note: tsb0 platform LEDs visually appear to have different brightness PWM
 * duty cycling is also used to bring all three LEDs to a similar brightness
 * level. LED0 (red) and LED2 (blue) are dimmed down to LED1 (green) level.
 * 
 * Copyright Thinnect Inc. 2019
 * 
 * @modifications Johannes Ehala, ProLab, 15 April 2020
 * @license MIT
 */
#include <stdio.h>
#include <stdint.h>
